...
{
    return _cairo_int64_eq (_cairo_int32x32_64_mul (a->Δy, b->Δx),
			    _cairo_int32x32_64_mul (b->Δy, a->Δx));
}

static inline cairo_bool_t
_cairo_slope_backwards (const cairo_slope_t *a, const cairo_slope_t *b)
{
    return _cairo_int64_negative (_cairo_int64_add (_cairo_int32x32_64_mul (a->Δx, b->Δx),
						    _cairo_int32x32_64_mul (a->Δy, b->Δy)));
}
